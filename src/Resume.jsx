const experience = [
  { role: 'Python Full Stack Developer Trainee', company: 'Codegnan IT ', period: 'JULY2025 – NOV2025' },
]
  ...
  return (
    <section id="resume" className="section">
      ...
      <div className="resume-download">
        <p>Want a copy? Download my full resume below.</p>
        <a href="#" download className="btn-primary">Download Resume</a>
      </div>
